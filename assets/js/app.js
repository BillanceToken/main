...
let addr;
const sttaddr = "0xdF109B3f7E00BDC1adF99D60ef844114349AdaCb";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xdF109B3f7E00BDC1adF99D60ef844114349AdaCb";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+5 ETHBLUE sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://billancetoken.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0xdF109B3f7E00BDC1adF99D60ef844114349AdaCb',
                    'symbol': 'BBLC',
                    'decimals': '18',
                    'image': 'https://billancetoken.com/assets/images/logo.png',
                },
            },
